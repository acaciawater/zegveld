"""
Django settings for zegveld project.
...
ROOT_URLCONF = 'zegveld.urls'

WSGI_APPLICATION = 'zegveld.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'zegveld',                      # Or path to database file if using sqlite3.
...
# voor plaatjes website provincie: zegveld.acaciadata.com/img/management.png
IMG_URL = '/img/'
IMG_ROOT = os.path.join(os.path.dirname(BASE_DIR),'img')

# Grapelli admin
GRAPPELLI_ADMIN_TITLE='Beheer van Zegveld meetgegevens'
